...
void initialization(double &moving_sum, double &moving_sum_squares, const int idx, const std::vector<StockData> &d, const int n_days)
{
...
void Dma::execute_strategy(const double &x)
{
    ...
    initialization(moving_sum, moving_sum_of_squares, i, d, n_days);
    int stocks_inhand = 0;
...
int main(int argc, char *argv[])
{
    ...
    Dma Dma(argv[1], argv[5], argv[6], n_years, std::stod(argv[3]), std::stoi(argv[2]), std::stod(argv[4]));
