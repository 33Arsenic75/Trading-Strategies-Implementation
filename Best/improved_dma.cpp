...
// {
//     Improved_Dma Improved_Dma(argv[1], argv[8], argv[9], std::stoi(argv[2]), std::stod(argv[3]), std::stoi(argv[2]), std::stod(argv[4]), std::stod(argv[6]), std::stod(argv[7]), std::stoi(argv[5]));
